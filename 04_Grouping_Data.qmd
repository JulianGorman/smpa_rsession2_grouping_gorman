...
ggplot(CAE_Flight_delays, aes(x = carrier, y = avg_delay)) +
  geom_col() +
  coord_flip() + 
  geom_col(color = "#FF8633", fill = "#FF8633")+
  scale_y_continuous(name = "Average time of arrival delay", labels = scales::comma)+
  scale_x_discrete(name = "Carrier") +
    labs(title = "Average delay by carrier at Columbia, SC airport", 
       subtitle = "2013") +
